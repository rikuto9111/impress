...
struct Comment2: View {
    
    @State var anime:AnimeToukouitem
    ...
    var body: some View {
        ...
        NavigationLink(destination:Otherprofile(othuserid:anime.othUserId,registerday: anime.registerday),isActive: $isProfilenavigation){
        ...
        ZStack{
            VStack{
                ...
                HStack{
                    ...
                    Button(action:{
                        onTap.toggle()
                        updateGoodness(isGood:onTap,othUserId: anime.othUserId,documentId: anime.documentId,goodness:anime.goodness)
                    },label:{
                ...
                if istouchButton{
                    ForEach(anime.isComment,id:\.self){ comment in
            ...
            if isShown{
                ...
                CustomDialog10(isShown:$isShown,isEdit:$isEdit,onSave:
                                {
                    let dating = Date()
                    let day = formatter.string(from: dating)
                    
                    updateEdit(isComment:isEdit,othUserId:anime.othUserId,documentId:anime.documentId,date:day)
    ...
    private func updateEdit(isComment:String,othUserId:String,documentId:String,date:String){
        ...
        db.collection("user")
            ...
            .getDocument{snapshot,error in
                ...
                anime.isComment.append(newComment)
            }
    }
...
struct CustomDialog10: View {//こいつを呼び出すだけでviewを表示するんだね
