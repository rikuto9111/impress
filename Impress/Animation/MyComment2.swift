...
struct MyComment2: View {
    ...
    var body: some View {
       ...
       /* NavigationLink(destination:Otherprofile(othuserid:anime.othUserId,createAt: anime.createAt),isActive: $isProfilenavigation){
        ...
        ZStack{
            ...
            if isShown{
                ...
                CustomDialog11(isShown:$isShown,isEdit:$isEdit,onSave:
                                {
                    let dating = Date()
...
struct CustomDialog11: View {//こいつを呼び出すだけでviewを表示するんだね
